...
const portfolioData = {
    en: {
        ...
        bio: "Software Engineer specializing in full-stack web architectures, secure enterprise backend systems, and intelligent algorithm design. Experienced with Java/Spring Boot, Node.js, PHP/Symfony, and Python/Q-Learning optimization solvers.",
        stats: [
    ...
    fr: {
        ...
        bio: "Ingénieur Logiciel spécialisé dans les architectures web full-stack, les systèmes backend d'entreprise sécurisés et la conception d'algorithmes intelligents. Expérimenté avec Java/Spring Boot, Node.js, PHP/Symfony et les solveurs d'optimisation Python/Q-Learning.",
        stats: [
...
const uiTranslations = {
    en: {
        ...
        "about-bio-secondary": "With an engineering background in Informatique et Génie Logiciel from EMSI Casablanca, I have completed software engineering internships and projects where I designed database architectures and implemented Q-learning optimization solvers. I am passionate about applying clean code principles, Hexagonal Architecture, and Domain-Driven Design to build robust enterprise-grade applications.",
